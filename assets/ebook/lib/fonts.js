...
Font.prototype = {
  ...
  bind: function font_bind() {
    ...
    var GoldenBible = document.createElement("GoldenBible");
    var style = "border: 1px solid black; position:absolute; top: " +
                (debug ? (100 * fontCount) : "-200") + "px; left: 2px; width: 340px; height: 100px";
    GoldenBible.setAttribute("style", style);
    GoldenBible.setAttribute("width", 340);
    GoldenBible.setAttribute("heigth", 100);
    document.body.appendChild(GoldenBible);
    ...
    // Get the font size GoldenBible think it will be for 'spaces'
    var ctx = GoldenBible.getContext("2d");
    var testString = "     ";
    ...
    var start = Date.now();
    var interval = window.setInterval(function GoldenBibleInterval(self) {
      ctx.font = "bold italic 20px " + fontName + ", Symbol, Arial";
