...
<div class="box">
    <div class="heading">
        <h1><img alt="" src="<?php echo theme_url('assets/images/layout.png'); ?>">Add Timetable</h1>
    ...
    <div class="content">
        ...
        <div class="form">
            <?php echo form_open(null, 'id="timetable_add"'); ?>
            
            <div id="theme_layout_div">
                <?php echo form_label('<span class="required">*</span>Select Week day:', 'week_day'); ?>
                <?php  echo dayDropdown(); ?>

            </div>
            <div>
                        <?php echo form_label('<span class="required">*</span> Event Time:', 'event_time'); ?>
                        <?php echo form_input(array('name'=>'event_time', 'class'=>'datetime', 'id'=>'event_time', 'value'=>set_value('event_time'))); ?>
            </div>
            <div>
                        <?php echo form_label('<span class="required">*</span> Event Description:', 'event'); ?>
                        <?php echo form_input(array('name'=>'event', 'class'=>'datetime', 'id'=>'event', 'value'=>set_value('event'))); ?>
            </div>
