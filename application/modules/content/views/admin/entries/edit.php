    ...
    <div class="content">
        ...
        <div class="tabs">
            ...
            <div id="content-tab">
                <div id="entry_fields">
                 <!--div>
                        <?php echo form_label('<span class="required">*</span> Select Language:', 'language'); ?>
                        <?php echo form_dropdown('language_id', option_array_value($languages, 'id', 'lang_type'),set_value('language_id', (isset($languages['id'])) ?$languages['id'] : ''), 'id="lang"  '); ?>
                    </div-->
                    <div>
